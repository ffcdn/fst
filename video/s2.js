...
var itemsAppId = [];
var remen = ["最热影视","热映影视","超燃电影","票房第一","超火影片","影视","影片","热血影片"];
var pmtype = ["髙青","全髙青","8k超青","4k髙青","藍光","超青","HD髙青"];
var chang = ["苌","長","萇"];
var jing = ["垏","津"];
var hu = ["湖","瑚"];
var guankan = ["线上观看","立既看","精彩看","兔费看","抢先观影","实时观看","线上观影","一同观看","在线譒放","开始譒放","点击譒放","现在播出","加长版","网上观影","线上观影","欢迎品鉴","观影","完整版","未删减版","——彩蛋版"] ;
var rt = [] ;
rt.push(randTitle(1));
rt.push(randTitle(2));
rt.push(randTitle(3));
